...
router.post('/stripe', express.raw({ type: 'application/json' }), async (req, res) => {
  ...
  try {
    switch (event.type) {
      // Copilot extension – existing logic preserved, Stripe Connect events added
      ...
      // Stripe Connect webhook events (Generated by Copilot – new module)
...
async function handlePaymentFailed(invoice) {
  ...
  // Send SMS if user opted in (Phase 5)
  try {
